    ...
    <section className="py-20 bg-white">
      <div className="container px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">What Our <span className="text-gradient">Clients Say</span></h2>
          ...
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="hover-lift rounded-xl overflow-hidden border-0 shadow-md">
              <CardContent className="p-8">
                ...
                <div className="relative">
                  <svg 
                    className="absolute -top-4 -left-4 h-8 w-8 text-aipurple-200" 
                    fill="currentColor" 
                    viewBox="0 0 32 32"
                  >
