    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 md:px-6 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-aipurple-400 to-aiblue-400 bg-clip-text text-transparent">
                AI Island
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">AI Consulting</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">Machine Learning</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">Chatbot Development</a>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to our newsletter to get the latest updates on AI trends.
            </p>
            <div className="flex space-x-2">
              <Input 
                placeholder="Your email address"
                className="bg-gray-800 border-gray-700 focus:ring-aipurple-500 focus:border-aipurple-500"
              />
              <Button className="bg-aipurple-500 hover:bg-aipurple-600">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} AI Island. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
